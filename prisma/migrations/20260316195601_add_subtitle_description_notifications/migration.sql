...
INSERT INTO "new_Event" ("adminKey", "bannerImageUrl", "createdAt", "createdById", "description", "endTime", "hostEmail", "hostName", "id", "location", "publicId", "startTime", "themeColor", "title", "updatedAt") SELECT "adminKey", "bannerImageUrl", "createdAt", "createdById", "description", "endTime", "hostEmail", "hostName", "id", "location", "publicId", "startTime", "themeColor", "title", "updatedAt" FROM "Event";
DROP TABLE "Event";
